...
#show: backrefs.with(
  // format: links => text()[(Cited on p. #links.join(", ", last: " and "))],
  read: path => read(path),
)
...
#slide[
  ...
  #figure(
    stack(
      dir: ltr,
      image("s3/nebellum/noah.gif", height: 50%),
      grid(
        columns: 2,
        inset: 0.5em,
        image("s3/nebellum/noah_0.gif", height: 25%),
        image("s3/nebellum/noah_1.gif", height: 25%),

        image("s3/nebellum/noah_2.gif", height: 25%),
        image("s3/nebellum/noah_3.gif", height: 25%),
      ),
    ),
...
#slide[
  ...
  multimodal large language model, Gemma @teamGemma3Technical2025, to decode
  pieces of intel, and a vectorized war game, Parabellum, to assign _importance_
  to those pieces.

][
  #figure(image("s3/nebellum/sims_sim copy.svg", width: 100%), caption: [
...
#slide[
  ...
  #esch(
    image("s3/nebellum/diff.svg", height: 80%),
  ...
  #figure(
    esch(
      stack(
        ...
        spacing: 1em,
        esch(
          image("s3/nebellum/importance_red.svg", width: 95%),
          // ylabel: [Blue],
        ),
        $——————————$,
        esch(
          image(
            "s3/nebellum/importance_blue.svg",
            width: 95%,
          ),
          // ylabel: [Red],
          xlabel: [Intel],
