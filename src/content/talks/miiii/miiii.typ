...
#slide[
  ...
  #esch(
    image("figs/13_nanda_y.svg", height: 80%),
    xlabel: $x_1$,
    ylabel: $x_0$,
    title: [Remainders],
...
#slide[
  ...
  // #esch(
  // image("figs/anim_grid.svg", height: 100%),
  // xlabel: $x_0$,
  // ylabel: $x_1$,
...
#slide[
  ...
  #meanwhile
  #figure(image("figs/nanda_y.svg", width: 80%), caption: [Target $y$ for as
    $x_0$ and $x_1$ move from $0$ to $p -1$ for the task
    $x_0 + x_1 mod p = y$])
]

== Grokking @nandaProgressMeasuresGrokking2023
...
#focus-slide[
  #figure(image("figs/polar.svg"), caption: [$NN < p^2$ multiples of 13 or 27
    (left) 11 (mid.) or primes (right)])
]
...
#slide[
  ...
  #meanwhile
  #figure(image("figs/pos_emb.svg", width: 100%), caption: [Positional
...
#slide[
  ...
  #figure(
    // stack(image("figs/neurs_113_nanda.svg"), image(
