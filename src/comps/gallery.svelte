<script>
    ...
    text = `${text} Limited edition prints can be bought by <a href='mailto:contact@syrkis.com'>email</a>. Proceeds go to the <a href="https://virian.com" target=_blank>Virian Project</a>.`
