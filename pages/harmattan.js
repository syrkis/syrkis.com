...
<div className='summary'>
	   ...
	   <br/><br/><br/> 
                    <div>
						...
						<p><i>{`The Girl`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/family.jpg" alt="The Day"/>
						<p><i>{`The Family`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/boy.jpg" alt="The Boy"/>
						<p><i>{`The Boy`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/girls.jpg" alt="The Girls"/>
						<p><i>{`The Girls`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/model.jpg" alt="The Model"/>
						<p><i>{`The Model`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/night.jpg" alt="The Night"/>
						<p><i>{`The Night`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/man.jpg" alt="The Man"/>
						<p><i>{`The Man`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/day.jpg" alt="The Girl"/>
						<p><i>{`The Day`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
                        <img src="https://images.syrkis.com/harmattan/scout.jpg" alt="The Scout"/>
						<p><i>{`The Scout`}</i>, {`2015, 59 x 84 cm, 300 €, limited edition of 9.`}</p>
