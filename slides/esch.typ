...
- Often denoted $xi = {s_1, s_2, ...}$ or in the continuous case ${s_i : i in RR}$ #pause
- The family of alphabets famously include ${A, B, ..., Z}$, ${0, 1}$, and ${A, C, T, G}$ #pause
...
- [$8 space 2 space 4 space 2 space 6 space 8$] becomes [$square.filled.big square.filled.tiny square.filled.small square.filled.tiny square.filled.medium square.filled.big$] ... or, depending on the font, [$circle.filled.big circle.filled.tiny circle.filled.small circle.filled.tiny circle.filled circle.filled.big$]
- Negative numbers become [$square.stroked.big square.stroked.tiny square.stroked.small square.stroked.tiny square.stroked.medium square.stroked.big$] (or [$circle.stroked.big circle.stroked.tiny circle.stroked.small circle.stroked.tiny circle.stroked circle.stroked.big$])
...
#slide[
  ...
  #figure(
    image("s3/esch/grid.svg", width: 100%),
    caption: [Esch representation of $J_(5,10)$],
  )
]

#focus-slide[
  #figure(
    image("s3/esch/anim_grid.svg", width: 100%),
    caption: [Esch of $A in RR^(5 times 10 times 100)$ (last dimension is temporal)],
  )
]
...
#figure(
  image("s3/esch/neuroscope.svg", width: 70%),
  caption: [Esch representation of $J_(5,10)$],
)
...
#figure(
  image("s3/esch/anim_sims.svg", height: 60%),
  caption: [Esch representation of random actions in Parabellum @anne2025],
)
